...
$pirouette_attr 	= '';
$pirouette_style 	= array();

if( isset( $curly_layer_parallax ) && filter_var( $curly_layer_parallax, FILTER_VALIDATE_BOOLEAN ) ){


	$pirouette_style[] 	= ! empty( $curly_layer_1_vertical ) ? "$curly_layer_1_vertical;" : '';
	$pirouette_style[] 	= ! empty( $curly_layer_1_horizontal ) ? "$curly_layer_1_horizontal;" : '';
	$pirouette_style[] 	= ! empty( $curly_layer_1_width ) ? "width: $curly_layer_1_width;" : '';
	$pirouette_style[] 	= ! empty( $curly_layer_1_height ) ? "height: $curly_layer_1_height;" : '';
	$pirouette_style[] 	= ! empty( $curly_layer_1_z ) ? "z-index: $curly_layer_1_z;" : '';

	$pirouette_attr 	= $curly_layer_1_ratio  === 1 || $curly_layer_1_ratio  === '1' ? '' : " data-stellar-ratio='$curly_layer_1_ratio' ";
	$el_class 		= "parallax-image $el_class";

}

$pirouette_style[] = isset( $curly_max_width ) && ! empty( $curly_max_width ) ? "max-width: $curly_max_width;" : '';
$pirouette_style[] = isset( $curly_width ) && ! empty( $curly_width ) ? "width: $curly_width;" : '';

$pirouette_style = ' style="' . implode( ' ', $pirouette_style ) . '" ';
...
if( isset( $curly_hover ) && ! empty ( $curly_hover ) ){
	...
	$pirouette_attr .= ' data-img-hover="' . esc_url_raw( isset( $image_hover[0] ) ? $image_hover[0] : null ) . '" ';
}
...
$output = '
	<div class="' . esc_attr( trim( $css_class ) ) . '"' . $pirouette_style . $pirouette_attr . '>
